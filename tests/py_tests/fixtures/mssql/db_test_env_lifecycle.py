...
from py_tests.fixtures.mssql.db_models import Base, ChildTable, EnumOfEnumTypeTestTable, ParentTable, TypeTestTable
...
class MSSQLDBTestEnvironmentLifecycle(DBTestEnvironmentLifecycle):
    ...
    def setup_db(self, tx: Transaction) -> Dict[Type, List[Dict[str, Any]]]:
        ...
        # Avoiding Precision Discrepancies in MSSQL's datetime Data Type
